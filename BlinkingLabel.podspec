...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Salih Onder/BlinkingLabel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Salih Onder' => 'salih.onder@innovapptive.com' }
  s.source           = { :git => 'https://github.com/Salih Onder/BlinkingLabel.git', :tag => s.version.to_s }
